...
const DataTableDashboardSiswa7Hari = (prop: Proptype) => {
  ...
  const [filteredData, setFilteredData] = useState<Resume7HariPerbulan[]>(data);
  const [sortField, setSortField] = useState<keyof Resume7HariPerbulan | null>(
    null,
  );
  ...
  const handleSort = (field: keyof Resume7HariPerbulan) => {
                ...
                paginatedData.map((row, index) => (
                  <React.Fragment key={index}>
                    <TableRow>
                      ...
                      <TableCell>{row.total_siswa}</TableCell>
...
export default DataTableDashboardSiswa7Hari;
