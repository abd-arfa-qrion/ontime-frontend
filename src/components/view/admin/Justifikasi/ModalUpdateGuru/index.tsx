...
import { Box, ButtonBase, Modal, TextareaAutosize } from "@mui/material";
import React, { Dispatch, SetStateAction, useState } from "react";

type Props = {
  open: boolean;
  onClose: () => void;
  updateJustifikasi: JustifikasiGuru | any;
  setUpdateJustifikasi: Dispatch<SetStateAction<JustifikasiGuru | null>>;
  isLoading: string;
...
const ModalUpdateJustifikasiGuru = (props: Props) => {
  ...
  const handleAddJustifikasi = async (
    ...
    try {
      ...
      formData.append("teacher_id", updateJustifikasi?.teacher_id);
      ...
      console.log("payload justifikasi:", {
        teacher_id: updateJustifikasi?.teacher_id,
      ...
      // request api
      const result = await justifikasiServices.updateDataJustifikasiGuru(
        formData,
  ...
  return (
    <Modal open={true} onClose={() => setUpdateJustifikasi(null)}>
      <Box
        sx={{
          width: 560,
          maxHeight: "92vh",
            ...
            <div className="p-5 flex flex-col gap-5">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-800">Data Guru</h4>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-white rounded-xl p-3 border border-slate-200">
                    ...
                    <p className="font-semibold text-slate-800">
                      {updateJustifikasi?.teacher_name}
                    </p>
                  </div>
...
export default ModalUpdateJustifikasiGuru;
